...
def run_experiment(hparams):
  ...
  train_input = lambda: model.train_input_fn(
    filename=hparams.data_file,
    batch_size=hparams.train_batch_size
  )
  ...
  eval_input = lambda: model.eval_input_fn(
    filename=hparams.data_file,
    batch_size=hparams.eval_batch_size
  )
  ...
  #exporter = tf.estimator.FinalExporter('cnn', model.serving_input_fn)
